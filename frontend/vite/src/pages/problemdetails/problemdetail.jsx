...
const ProblemPage = () => {
  ...
  const handleEditorChange = (value) => {
    ...
    setCode(newCode);
    dispatch(
      updateCode({ problemId, language: selectedLanguage, code: newCode }),
    );
  };
  ...
  const handleSubmitCode = async () => {
    ...
    try {
      const response = await axiosClient.post(
        `/submit/submitproblem/${problemId}`,
        {
          code: code,
          language: selectedLanguage,
        },
            ...
            {["description", "askzai"].map((tab) => {
              ...
              return (
                <button
                  ...
                  title={
                    isZAiLocked ? "Submit a failed attempt to unlock ZAi" : ""
                  }
                >
                  {tab === "description"
                    ? "Description"
                  ...
                  <div className="bg-[#121826]/40 border border-slate-800/60 rounded-xl p-5 space-y-4 shadow-xl">
                    ...
                    <ul className="space-y-3 list-disc pl-5 font-sans text-sm text-slate-300">
                      ...
                      <li className="leading-relaxed marker:text-slate-500">
                        Time Limit:{" "}
                        <span className="font-mono bg-[#161F30] border border-slate-800/60 text-slate-200 px-1.5 py-0.5 rounded text-xs">
                          {problem.constraints?.timeLimit || "2.0"}s
                        </span>
                      </li>
                      <li className="leading-relaxed marker:text-slate-500">
                        Memory Limit:{" "}
                  ...
                  <div className="flex flex-col items-center justify-center h-full pt-8 pb-4">
                    <div className="flex flex-col items-center space-y-4 mb-10">
                      <div className="flex items-center justify-center h-12 w-12 rounded-xl bg-[#090D16] border border-slate-800 shadow-inner relative overflow-hidden">
                        ...
                        <span className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-400 to-cyan-400 relative z-10 font-sans">
                          Z
                        </span>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-slate-400 text-xs">
                          Hints, explanations, strategy — no spoilers.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="w-full mt-auto">
                      <div className="flex items-end gap-3">
                        ...
                        <div className="bg-[#161F30] border border-slate-700/50 rounded-2xl rounded-tl-sm px-4 py-3 text-[13px] leading-relaxed text-slate-300 shadow-sm">
                          Hey there 👋 I'm Z — your mindful coding guide. I'm
                          here to help you think through problems, understand
                          concepts, and sharpen your approach. Ask me anything
                          to get started.
                        </div>
                      </div>
                    </div>
                      ...
                      {msg.role === "user" ? (
                        ...
                        <div className="flex items-start gap-4 w-full">
                          <div className="flex h-4 w-4 mt-0.5 shrink-0 items-center justify-center rounded bg-indigo-500/20 shadow-sm border border-indigo-500/30">
                            <span className="text-[10px] font-bold text-indigo-400 font-sans tracking-tighter">
                              Z
                            </span>
                          </div>
                      ...
                      <div className="space-y-3">
                        {runResult.results?.map((tc, i) => {
                          ...
                          return (
                            <div
                              key={i}
                              className="group relative bg-[#121826]/40 hover:bg-[#161F30]/60 border border-slate-800/60 rounded-xl p-4 transition-all duration-200"
                            >
                              <div
                              ...
                              <div className="pl-2 space-y-3">
                                ...
                                <div className="space-y-2.5 text-slate-300">
                                  <div className="grid grid-cols-[80px_1fr] items-start gap-2">
                                    <span className="text-[11px] font-bold text-slate-500 uppercase tracking-widest pt-1">
                                      Input
                                    </span>
                                  ...
                                  {tc.actual && (
                                    <div className="grid grid-cols-[80px_1fr] items-start gap-2">
                                      ...
                                      <div
                                        className={`bg-[#070C15] border rounded-lg px-3 py-1.5 font-mono text-xs ${
                                          isSuccess
                                  ...
                                  {tc.stderr && (
                                    <div className="grid grid-cols-[80px_1fr] items-start gap-2 pt-1">
                                      <span className="text-[11px] font-bold text-rose-500 uppercase tracking-widest pt-1">
                                        Stderr
                                      </span>
                ...
                {submitResult ? (
                  <div className="space-y-4">
                    {(() => {
                      ...
                      return (
                        <div
                          className={`p-5 rounded-xl border flex items-start gap-4 shadow-lg ${bannerStyles}`}
                        >
