...
function CopyCodeButton({ code }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="absolute top-2 right-2 p-1.5 z-10 rounded-md bg-slate-800/80 hover:bg-slate-700/80 text-slate-400 hover:text-white transition-all border border-slate-700/50 backdrop-blur-sm shadow-md"
