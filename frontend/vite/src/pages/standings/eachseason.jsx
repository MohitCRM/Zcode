                    ...
                    <div className="bg-[#0B111E]/80 backdrop-blur-md border border-slate-800/80 rounded-xl overflow-hidden shadow-2xl">
                        ...
                        <div className="divide-y divide-slate-800/40">
                            {data.standings.map((user) => (
                                <div 
                                    key={user.userId}
                                    className="px-6 py-3.5 grid grid-cols-[80px_1fr_120px_140px_100px] gap-4 items-center bg-transparent hover:bg-[#121826]/40 transition-all duration-150 ease-out"
                                >
                                    {/* Rank Marker Layout */}
                                    <div className={`font-mono font-bold text-sm ${getRankColor(user.rank)}`}>
                                        #{user.rank}
                                    </div>
